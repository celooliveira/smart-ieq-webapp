<template>
  <div id="nav">
    <el-form v-if="!loginState" :model="loginForm" :inline="true">
      <el-form-item label="Usuário" size="medium">
    ...
    <template v-else>
      <el-button type="default" @click="refreshDevices()">Atualizar</el-button>
      <el-button type="default" @click="logout()">Sair</el-button>
    </template>
  </div>
  <div id="devices">
...
const login = async () => {
  try {
    ...
    ElMessage.error(`Erro ao Entrar (${err})`)
  }
}
...
const refreshDevices = async () => {
  ...
  try {
    ...
    ElMessage.error(`Erro ao listar dispositivos. (${err})`)
  }
}
...
const toggleDevice = async (device) => {
  ...
  try {
    ...
    ElMessage.error(`Erro ao enviar comando ao dispositivo. (${err})`)
  }
}
